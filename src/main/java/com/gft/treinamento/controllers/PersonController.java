...
//	NÃO UTILIZAR DE FORMA ALGUMA FORWARD COM O MÉTODO POST ABAIXO -> GERA LOOP INFINITO
	...
	public ModelAndView deletePerson(@RequestParam Long id, RedirectAttributes redirectAttributes) {
		...
		try {
			...
			redirectAttributes.addFlashAttribute("message", "Erro ao excluir pessoa, possivelmente não existe.");
		}
